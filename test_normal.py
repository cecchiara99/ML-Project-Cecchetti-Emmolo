...
print(f"Anderson-Darling test statistic 2: {result_2.statistic}, critical values: {result_2.critical_values}, significance level: {result_2.significance_level}")
...
print(f"Anderson-Darling test statistic 3: {result_3.statistic}, critical values: {result_3.critical_values}, significance level: {result_3.significance_level}")
...
print(f"Lilliefors test statistic: {result_1}, p-value: {p_value_1}")

result_2, p_value_2 = lilliefors(all_values_2)
print(f"Lilliefors test statistic: {result_2}, p-value: {p_value_2}")

result_3, p_value_3 = lilliefors(all_values_3)
print(f"Lilliefors test statistic: {result_3}, p-value: {p_value_3}\n")
